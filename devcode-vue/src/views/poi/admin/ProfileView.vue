          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Detalle
                    General</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <h5 class="card-title">Detalles del Perfíl</h5>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"> {{ userLastName }}</div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="userName">
                      </div>
                    </div>
...
const userImage = ref('');
const userName = ref('');      // Correctamente definido
const userEmail = ref('');      // Correctamente definido
const userLastName = ref('');  // Define userLastName también
...
const LISTAR = async () => {
  ...
  try {
    const response = await api.get('user/profile/', { headers });
      ...
      userEmail.value = response.data.email || 'Sin Email';
