      ...
      <table class="modern-table">
        <thead>
          <tr>
            ...
            <th class="numeric-col">Comentario</th>
            ...
            <tr :class="{
              ...
              <td class="numeric-input">
                <input v-model.number="reporte.prog_5_21" type="text" :disabled="!reporte.campos_bloqueados"
                  ...
                  :placeholder="reporte.prog_5_21 === null || reporte.prog_5_21 === '' ? '0.00' : ''">
              </td>
              <td class="numeric-input">
                <input v-model.number="reporte.prog_5_23" type="text" :disabled="!reporte.campos_bloqueados"
                  @keydown="validarInput"
                  :placeholder="reporte.prog_5_23 === null || reporte.prog_5_23 === '' ? '0.00' : ''">
              </td>
              <td class="numeric-input">
                <input v-model.number="reporte.prog_5_26" type="text" :disabled="!reporte.campos_bloqueados"
                  @keydown="validarInput"
                  :placeholder="reporte.prog_5_26 === null || reporte.prog_5_26 === '' ? '0.00' : ''">
              </td>


              <!-- Campo de Prog. PRESUPUESTAL, solo lectura -->
              <td class="numeric-input">
                <input :value="calcularProgPpto(reporte)" type="text" class="readonly-cell" readonly placeholder="0.00">
              </td>
              ...
              <td class="numeric-input">
                <input v-model.number="reporte.act_5_21" type="text" :disabled="!reporte.campos_bloqueados"
                  @keydown="validarInput"
                  :placeholder="reporte.act_5_21 === null || reporte.act_5_21 === '' ? '0.00' : ''">
              </td>
              <td class="numeric-input">
                <input v-model.number="reporte.act_5_23" type="text" :disabled="!reporte.campos_bloqueados"
                  @keydown="validarInput"
                  :placeholder="reporte.act_5_23 === null || reporte.act_5_23 === '' ? '0.00' : ''">
              </td>
              <td class="numeric-input">
                <input v-model.number="reporte.act_5_26" type="text" :disabled="!reporte.campos_bloqueados"
                  @keydown="validarInput"
                  :placeholder="reporte.act_5_26 === null || reporte.act_5_26 === '' ? '0.00' : ''">
              </td>
              <td class="numeric-input">
                <input :value="calcularActPpto(reporte)" type="text" class="readonly-cell" readonly placeholder="0.00">
              </td>
              ...
              <td class="numeric-input">
                <input v-model.number="reporte.ejec_5_21" type="text" :disabled="!reporte.campos_bloqueados"
                  @keydown="validarInput"
                  :placeholder="reporte.ejec_5_21 === null || reporte.ejec_5_21 === '' ? '0.00' : ''">
              </td>
              <td class="numeric-input">
                <input v-model.number="reporte.ejec_5_23" type="text" :disabled="!reporte.campos_bloqueados"
                  @keydown="validarInput"
                  :placeholder="reporte.ejec_5_23 === null || reporte.ejec_5_23 === '' ? '0.00' : ''">
              </td>
              <td class="numeric-input">
                <input v-model.number="reporte.ejec_5_26" type="text" :disabled="!reporte.campos_bloqueados"
                  @keydown="validarInput"
                  :placeholder="reporte.ejec_5_26 === null || reporte.ejec_5_26 === '' ? '0.00' : ''">
              </td>
              <td class="numeric-input">
                <input :value="calcularEjecPpto(reporte)" type="text" class="readonly-cell" readonly placeholder="0.00">
              </td>
              <td>
                <input v-model="reporte.comentario" type="text" :disabled="!reporte.campos_bloqueados"
                  class="comment-input" placeholder="Escribe tu comentario...">
              </td>
...
const LISTAR = async () => {
  try {
    ...
    reportes.value = response.data.map(reporte => {
      // Forzar BLOQUEO para mes anterior (true = bloqueado)
  ...
  try {
    await Promise.all(reportes.value.map(async (reporte) => {
      ...
      const datosActualizar = {
        ...
        comentario: reporte.comentario || '', // Añade esta línea
